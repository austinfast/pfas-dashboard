...
var layerControl = L.control.layers(overlayLayers, null, { //null per https://gis.stackexchange.com/questions/64385/making-leaflet-control-open-by-default
  collapsed: false
}).addTo(map);
...
// Filter jsonData for the matching PWSID
    var filteredRows = jsonData.filter(function(row) {
